...
export const createThread = createAsyncThunk(
    ...
    async ({ title, comment }: { title: string; comment: string }) => {
        ...
        const response = await fetch('/api/threads/thread', {
            method: 'POST',
            mode: 'cors',
            credentials: 'include',
            headers: {
...
export const searchThreads = createAsyncThunk(
    ...
    async ({ searchTerm }: { searchTerm: string }) => {
        if (searchTerm) {
            const response = await fetch(`/api/threads/${searchTerm}`, {
                mode: 'cors',
                credentials: 'include',
            })
            if (response.ok) {
...
export const likeThreadToggle = createAsyncThunk(
    ...
    async ({ threadId, method }: { threadId: string; method: string }) => {
        const response = await fetch(`/api/like/thread/${threadId}`, {
            method: 'PUT',
            mode: 'cors',
            credentials: 'include',
        })
...
export const getMostLikedThreads = createAsyncThunk(
    ...
    async () => {
        const response = await fetch('/api/threads/mostLiked', {
            method: 'GET',
            mode: 'cors',
            credentials: 'include',
        })
...
export const addComment = createAsyncThunk(
    ...
    async ({ threadId, comment }: { threadId: string; comment: string }) => {
        ...
        await fetch(`/api/comments/${threadId}`, {
            method: 'POST',
            mode: 'cors',
            credentials: 'include',
            headers: {
...
export const likeCommentToggle = createAsyncThunk(
    ...
    async ({ commentId }: { commentId: string }) => {
        const response = await fetch(`/api/like/comment/${commentId}`, {
            method: 'PUT',
            mode: 'cors',
            credentials: 'include',
        })
